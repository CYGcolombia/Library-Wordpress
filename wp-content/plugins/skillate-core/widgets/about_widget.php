...
add_action('widgets_init','register_skillate_core_about_widget');

function register_skillate_core_about_widget()
{
	register_widget('skillate_Core_About_Widget');
}

class skillate_Core_About_Widget extends WP_Widget{

	public function __construct() {
		parent::__construct( 'skillate_Core_About_Widget', esc_html__("skillate About Us Widgets",'Skillate-core'), array('description' => esc_html__("This About Us Widgets",'Skillate-core')) );
	}
	...
	*-------------------------------------------------------*/
	public function widget( $args, $instance ) {
		...
		if(isset($instance['about_img1']) && !empty($instance['about_img1'])) {
			echo '<img src="'. esc_url(get_site_url()) . $instance['about_img1'].'" class="img-responsive" alt="'.esc_html__('image','Skillate-core').'">';
		}
		...
		<ul class="themeum-about-info">
			...
			<?php if( isset($instance['fax_no']) && $instance['fax_no'] ) { ?>
				<li><span><?php esc_html_e('Fax: ', 'Skillate-core'); ?></span><?php echo $instance['fax_no']; ?></li>
			<?php } ?>
		</ul>
		<?php
		echo $after_widget;
	...
	*-------------------------------------------------------*/
	public function form( $instance ) {
	   ...
	   ?>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php _e('Title :', 'Skillate-core'); ?></label>
			<input id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" value="<?php echo esc_attr($instance['title']); ?>" style="width:100%;" />
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'about_img1' )); ?>"><?php esc_html_e( 'About Image URL', 'Skillate-core' ); ?></label>
			<input type="hidden" id="<?php echo $this->get_field_id('about_img1');?>" name="<?php echo $this->get_field_name('about_img1');?>" class="<?php echo $this->get_field_id('about_img1');?>" value="<?php echo $instance['about_img1']; ?>"/>
 			<button id="<?php echo $this->get_field_id('about_img1');?>" class="custom-upload button" data-url="<?php echo esc_url(get_site_url()); ?>"><?php echo esc_html__('Upload image','Skillate-core'); ?></button>
 			<img class="<?php echo $this->get_field_id('about_img1');?>" src="<?php echo esc_url(get_site_url()) . $instance['about_img1']; ?> "/>
		</p>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'about_text' )); ?>"><?php esc_html_e('About Text :', 'Skillate-core'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'phone_no' )); ?>"><?php esc_html_e('Phone No: ', 'Skillate-core'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'about_email' )); ?>"><?php esc_html_e('Email ID: ', 'Skillate-core'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'fax_no' )); ?>"><?php esc_html_e('Fax No: ', 'Skillate-core'); ?></label>
