							...
							<div class="primary-menu">
								<div class="row align-items-center">
																...
																<a href="<?php echo $term_link; ?>">
																	<div class="media">
																		<div class="cat-media-img">
																			<img src="<?php echo !empty($shop_catalog_img[0]) ? $shop_catalog_img[0] : ''; ?>" alt="<?php echo $course_cat->name; ?>" />
																		</div>
									...
									if (function_exists('tutor_utils')) : ?>
										<div class="col-md-auto <?php echo esc_attr($en_search_class); ?>col-auto header-login-cart-wrap d-flex align-items-center">
											<?php
											...
											<?php if (is_user_logged_in()) { ?>
												<div class="skillate-header-login d-inline-block ml-4">
													<div class="header_profile_menu">
														<div class="skillate_header_profile_photo d-flex align-items-center">
															<?php
															if (function_exists('tutor_utils')) {
