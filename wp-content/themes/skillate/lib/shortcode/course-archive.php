                        ...
                        <li>
                            <a class="breadcrumb_home total-courses">
                                <?php
                                    ...
                                    printf( __( 'Viewing %s Courses of %s', 'skillate' ), "<strong>{$q->post_count}</strong>", "<strong>{$q->found_posts}</strong>" );
                                ?>
                            </a>
                        </li>
                    </ol>
                                        ...
                                        <?php if ( count( $childern ) ) : ?>
                                            <?php foreach ( $childern as $child ) { ?>
                                                ...
                                                <input
                                                    ...
                                                    type="checkbox"
                                                    name="course_category[]"
                                                    value="<?php echo esc_attr( strtolower( $child->name ) ) ?>"
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="skillate-course-media mb-lg-0 mb-4">
                                        ...
                                        <div class="course-media-hover">
                                            <a class="btn btn-classic btn-no-fill" href="<?php the_permalink(); ?>">
                                                <?php echo _e( 'View Course', 'skillate' ); ?>
                                            </a>
                                            <div class="skillate-course-enroll-btn">
                                                ...
                                                $first_lesson_url = $lesson_url ? tutor_utils()->get_course_first_lesson( $course_id, tutor()->lesson_post_type ) : get_the_permalink();
                                ...
                                <div class="col-lg-5 col-sm-8 order-2 order-sm-1">
                                    <div class="skillate-course-body mb-sm-0 mb-3">
                                        ...
                                        <div class="course-archive-single-meta">
                                            <span><?php echo wp_kses_post( get_tutor_course_level() ); ?></span>
                                            <span><?php echo wp_kses_post( get_tutor_course_duration_context_skillate() ); ?></span>
                                        ...
                                        <div class="tutor-meta course-archive-author">
                                            <a href="<?php echo $profile_url; ?>" class="tutor-d-flex">
                                                <?php echo tutor_utils()->get_tutor_avatar( $author_id, 'sm' ); ?>
                                            </a>
                                            <a class="tutor-meta-value" href="<?php echo $profile_url; ?>"><?php esc_html_e(get_the_author()); ?></a>
                                        </div>
                                    </div>
                                </div>
