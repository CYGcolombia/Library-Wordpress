                        ...
                        $output .= '<div class="tutor-course-overlay">';
                            ...
                            $output .= '<div class="tutor-course-grid-enroll">';
                                $output .= '<div class="course-related-hover-price">';
                                    ...
                                    $output .= ob_get_clean();
                                $output .= '</div>';
                                $output .= '<div class="tutor-course-grid-meta"><span class="tutor-course-grid-level">'.get_tutor_course_level($related_post->ID).'</span>';
                                $output .= '<span class="tutor-course-duration">'.get_tutor_course_duration_context_skillate().'</span></div>';
