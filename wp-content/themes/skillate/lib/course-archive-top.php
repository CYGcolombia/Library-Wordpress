                    ...
                    $output .= '<div class="tutor-course-grid-item">';
                        $output .= '<div class="tutor-course-grid-content">';
                            $output .= '<div class="tutor-course-overlay">';
                                ...
                                if ( ! empty( $thumb[0] ) ) { $output .= '<img src="'. $thumb[0] .'" class="img-responsive">'; }
                                ...
                                $output .= '<div class="tutor-course-overlay-element">';
                                    ...
                                    $output .= '<div class="bookmark">';
                                        $output .= '<span class="tutor-course-grid-wishlist tutor-course-wishlist">';
                                            ...
                                            $output .= '<a href="javascript:;" class="tutor-icon-bookmark-line tutor-course-wishlist-btn '.esc_attr($has_wish_list).' " data-course-id="'.get_the_ID().'"></a>';
                                            }else{
                                ...
                                $output .= '<div class="tutor-course-grid-enroll">';
                                    ...
                                    $output .= '<span class="tutor-course-duration">'.get_tutor_course_duration_context_skillate($featured_post->ID).'</span>';
                                    ...
                                    if (tutor_utils()->is_course_purchasable($featured_post->ID)) {
                                        ...
                                        if (tutor_utils()->is_See More($featured_post->ID)) {
                                            $output .= '<a href="'.esc_url(get_the_permalink($featured_post->ID)).'" class="btn btn-classic btn-no-fill">'.__('See More','skillate').'</a>';
                                        } else {
