                ...
                <div class="col-lg-5 col-sm-8 order-2 order-sm-1">
                    <div class="skillate-course-body mb-sm-0 mb-3">
                        ...
                        <div class="course-archive-single-meta">
                            <?php echo get_tutor_course_level() ? '<span>' . esc_html(get_tutor_course_level()) . '</span>' : null; ?>
                            <?php
                            echo get_tutor_course_duration_context_skillate() ? '<span>' . esc_html(get_tutor_course_duration_context_skillate()) . '</span>' : null;
                            ?>
