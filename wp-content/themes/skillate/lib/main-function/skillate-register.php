    ...
    function skillate_plugins_include()
    {
        $plugins = array(
                ...
                array(
                    ...
                    'force_activation'      => false,
                    'force_deactivation'    => false,
                    'external_url'          => esc_url( 'https://downloads.wordpress.org/plugin/gamipress.zip' ),
                ),
                array(
                    ...
                    'force_activation'      => false,
                    'force_deactivation'    => false,
                    'external_url'          => esc_url( 'https://downloads.wordpress.org/plugin/paid-memberships-pro.zip' ),
                ),
                array(
                    ...
                    'force_activation'      => false,
                    'force_deactivation'    => false,
                    'external_url'          => esc_url( 'https://downloads.wordpress.org/plugin/gamipress-tutor-integration.zip' ),
                ),
                array(
                    'name'                  => 'WooCoommerce',
                    'slug'                  => 'woocommerce',
