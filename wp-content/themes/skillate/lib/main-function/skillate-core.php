...
if (!function_exists('skillate_breadcrumb')) :
    ...
    { ?>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <?php if (is_tag()) { ?>
                    <?php esc_html_e('Posts Tagged ', 'skillate') ?><span class="raquo">/</span><?php single_tag_title();
                                                                                                echo ('/'); ?>
                <?php } elseif (is_day()) { ?>
...
if (!function_exists('skillate_css_generator')) {
    function skillate_css_generator()
    {
        ...
        $custom_preset = get_theme_mod('custom_preset_en', true);
        ...
        if ($preset && $custom_preset) {
            ...
            if ($major_color) {
                ...
                .splash-login-btn a, 
                .tutor-course-See More-review-wrap .write-course-review-link-btn, 
                ...
                $output .= 'span.tutor-text-avatar, .woocommerce table.shop_table td a.remove:hover{ background: ' . esc_attr($major_color) . '!important; }';
                $output .= '
                ...
                .comingsoon .mc4wp-form-fields input[type=submit], #sidebar h3.widget_title:before { background-color: ' . esc_attr($major_color) . '; border-color: ' . esc_attr($major_color) . '; }';
            }
            ...
            if ($hover_color) {
                ...
                .tutor-course-See More-review-wrap .write-course-review-link-btn:hover, 
            ...
            if ($major_color) {
                $output .= ":root {
                    ...
                    --tutor-color-primary-rgb: " . esc_attr(skillate_hex2rgb($major_color)) . ";
                }";
            }

            if ($hover_color) {
                $output .= ":root {
                    --tutor-color-primary-hover: " . esc_attr($hover_color) . ";
                    --tutor-color-primary-hover-rgb: " . esc_attr(skillate_hex2rgb($hover_color)) . ";
                }";
            }
        }
        ...
        if (get_theme_mod('body_google_font', 'Open Sans')) {
            $bstyle .= 'font-family:' . get_theme_mod('body_google_font', 'Open Sans') . ';';
        }
        if (get_theme_mod('body_font_weight', '400')) {
            $bstyle .= 'font-weight: ' . get_theme_mod('body_font_weight', '400') . ';';
        }
        if (get_theme_mod('body_font_height', '27')) {
            $bstyle .= 'line-height: ' . get_theme_mod('body_font_height', '27') . 'px;';
        }
        if (get_theme_mod('body_font_color', '#6a6a6a')) {
            $bstyle .= 'color: ' . get_theme_mod('body_font_color', '#1f2949') . ';';
        }
        ...
        if (get_theme_mod('menu_google_font', 'Open Sans')) {
            $mstyle .= 'font-family:' . get_theme_mod('menu_google_font', 'Open Sans') . ';';
        }
        if (get_theme_mod('menu_font_weight', '400')) {
            $mstyle .= 'font-weight: ' . get_theme_mod('menu_font_weight', '400') . ';';
        }
        if (get_theme_mod('menu_font_height', '20')) {
            $mstyle .= 'line-height: ' . get_theme_mod('menu_font_height', '20') . 'px;';
        }

        //heading1
        $h1style = '';
        if (get_theme_mod('h1_font_size', '44')) {
            $h1style .= 'font-size:' . get_theme_mod('h1_font_size', '44') . 'px;';
        }
        if (get_theme_mod('h1_google_font', 'Open Sans')) {
            $h1style .= 'font-family:' . get_theme_mod('h1_google_font', 'Open Sans') . ';';
        }
        if (get_theme_mod('h1_font_weight', '600')) {
            $h1style .= 'font-weight: ' . get_theme_mod('h1_font_weight', '600') . ';';
        }
        ...
        # heading2
        $h2style = '';
        if (get_theme_mod('h2_font_size', '40')) {
            $h2style .= 'font-size:' . get_theme_mod('h2_font_size', '40') . 'px;';
        }
        if (get_theme_mod('h2_google_font', 'Open Sans')) {
            $h2style .= 'font-family:' . get_theme_mod('h2_google_font', 'Open Sans') . ';';
        }
        if (get_theme_mod('h2_font_weight', '600')) {
            $h2style .= 'font-weight: ' . get_theme_mod('h2_font_weight', '600') . ';';
        }
        if (get_theme_mod('h2_font_height', '46')) {
            $h2style .= 'line-height: ' . get_theme_mod('h2_font_height', '46') . 'px;';
        }

        //heading3
        $h3style = '';
        if (get_theme_mod('h3_font_size', '20')) {
            $h3style .= 'font-size:' . get_theme_mod('h3_font_size', '20') . 'px ;';
        }
        if (get_theme_mod('h3_google_font', 'Open Sans')) {
            $h3style .= 'font-family:' . get_theme_mod('h3_google_font', 'Open Sans') . ' ;';
        }
        if (get_theme_mod('h3_font_weight', '600')) {
        ...
        //heading4
        $h4style = '';
        if (get_theme_mod('h4_font_size', '16')) {
            $h4style .= 'font-size:' . get_theme_mod('h4_font_size', '16') . 'px ;';
        }
        if (get_theme_mod('h4_google_font', 'Open Sans')) {
            $h4style .= 'font-family:' . get_theme_mod('h4_google_font', 'Open Sans') . ' ;';
        }
        if (get_theme_mod('h4_font_weight', '600')) {
        ...
        if (get_theme_mod('h5_google_font', 'Open Sans')) {
            $h5style .= 'font-family:' . get_theme_mod('h5_google_font', 'Open Sans') . ' ;;';
        }
        if (get_theme_mod('h5_font_weight', '600')) {
            $h5style .= 'font-weight: ' . get_theme_mod('h5_font_weight', '600') . ';';
        }
        if (get_theme_mod('h5_font_height', '26')) {
            $h5style .= 'line-height: ' . get_theme_mod('h5_font_height', '26') . 'px;';
        }
...
if (!function_exists('skillate_css_backend_generator')) {
    function skillate_css_backend_generator()
    {
        ...
        if (get_theme_mod('body_font_color', '#535967')) {
            $bstyle .= 'color: ' . get_theme_mod('', '#535967') . ';';
        }
        ...
        if (get_theme_mod('h1_font_color', '#1f2949')) {
            $h1style .= 'color: ' . get_theme_mod('h1_font_color', '#1f2949') . ';';
        }
        ...
        if (get_theme_mod('h2_font_height', '36')) {
            $h2style .= 'line-height: ' . get_theme_mod('h2_font_height', '36') . 'px;';
        }
        if (get_theme_mod('h2_font_color', '#1f2949')) {
            $h2style .= 'color: ' . get_theme_mod('h2_font_color', '#1f2949') . ';';
        }

        //heading3
        $h3style = '';
        if (get_theme_mod('h3_font_size', '24')) {
            $h3style .= 'font-size:' . get_theme_mod('h3_font_size', '24') . 'px;';
        }
        if (get_theme_mod('h3_google_font', 'Open Sans')) {
            $h3style .= 'font-family:' . get_theme_mod('h3_google_font', 'Open Sans') . ';';
        }
        ...
        if (get_theme_mod('h3_font_color', '#1f2949')) {
            $h3style .= 'color: ' . get_theme_mod('h3_font_color', '#1f2949') . ';';
        }
        ...
        if (get_theme_mod('h4_font_color', '#1f2949')) {
            $h4style .= 'color: ' . get_theme_mod('h4_font_color', '#1f2949') . ';';
        }
        ...
        if (get_theme_mod('h5_font_color', '#1f2949')) {
            $h5style .= 'color: ' . get_theme_mod('h5_font_color', '#1f2949') . ';';
        }
