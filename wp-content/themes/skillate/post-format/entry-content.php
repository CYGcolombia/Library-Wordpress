    ...
    <?php 
        if ( is_single() ) {
            ...
            if ( get_theme_mod( 'blog_author', true ) ){?>
                <div class="meta-author d-flex align-items-center">
                    <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) )); ?>" class="d-inline-flex">
                    <?php
                    ...
                    <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) )); ?>" class="d-inline-flex ml-2">
                        <h4 class="mb-0">
